...
xp14=np.sqrt((1+par.p)**2-b**2)
xp1=-xp14;xp4=+xp14
xp23=np.sqrt((1-par.p)**2-b**2)
xp2=-xp23;xp3=+xp23
...
print "\tRadius: Rp = %.3f Rsun."%par.p
print "\tScaled radius: p = %.4f."%par.p
...
print "Scaled planetary radius: p = Rp/Rs = %.6f"%(par.p)
